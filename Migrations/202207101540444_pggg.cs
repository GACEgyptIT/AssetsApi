namespace IntranetAPI.Migrations
{
    ...
    public partial class pggg : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        AssetInvoiceId = c.Int(nullable: false, identity: true),
                        astId = c.Int(nullable: false),
                        InvoiceId = c.Int(),
                        NationalCharges = c.Single(nullable: false),
                        InternationalCharges = c.Single(nullable: false),
                        InternetCharges = c.Single(nullable: false),
                        RoamingCharges = c.Single(nullable: false),
                        OtherCharges = c.Single(nullable: false),
                        TotalBeforeTaxs = c.Single(nullable: false),
                        NonTaxedCharges = c.Single(nullable: false),
                        TotalAfterTaxs = c.Single(nullable: false),
                        PersonalCharge = c.Single(nullable: false),
                        BusinessCharge = c.Single(nullable: false),
                    })
                .PrimaryKey(t => t.AssetInvoiceId)
                .ForeignKey("dbo.Assets", t => t.astId, cascadeDelete: true)
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.Employees", t => t.empId)
                .ForeignKey("dbo.ItemsCategories", t => t.icId)
                .ForeignKey("dbo.Suppliers", t => t.splId)
                .Index(t => t.splId)
                ...
                c => new
                    {
                        ...
                        astPurchaseDate = c.DateTime(precision: 7, storeType: "datetime2"),
                        IsExist = c.Boolean(),
                        duplicatCode = c.Boolean(),
                        duplicatSerialNumber = c.Boolean(),
                        duplicatDailNumber = c.Boolean(),
                        ByEmpId = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.astId);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.AssetTrackings", "empId", "dbo.Employees");
            DropForeignKey("dbo.AssetTrackings", "astId", "dbo.Assets");
            ...
            DropForeignKey("dbo.AssetInvoices", "InvoiceId", "dbo.Invoices");
            DropForeignKey("dbo.AssetInvoices", "astId", "dbo.Assets");
            ...
            DropIndex("dbo.AssetTrackings", new[] { "empId" });
            DropIndex("dbo.AssetTrackings", new[] { "astId" });
            ...
            DropIndex("dbo.AssetInvoices", new[] { "InvoiceId" });
            DropIndex("dbo.AssetInvoices", new[] { "astId" });
