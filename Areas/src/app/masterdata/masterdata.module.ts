...
@NgModule({
  declarations: [
    ...
    CodeguideComponent, 
    DomainComponent, SupplierComponent, CostCenterComponent, ItemscategoryComponent, AssettrackinglogComponent, ShowadaccountsComponent, OperatorComponent, EmpdirectoryComponent, UploademployeeComponent, OpraccnumberComponent, OperatorrateplanComponent
  ],
  imports: [
